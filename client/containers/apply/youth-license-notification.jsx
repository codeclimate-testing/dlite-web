...
const Form = (props) => {
  ...
  const checkAnswer = (isChecked) => {
    ...
    // update props.cardType.ID if user is under 15 - don't want to change it from yes to no for users who are over 15 who select "no" to getting an ID instead because they are able to start application for both ID and DL
    if(!props.cardType.ID || ageChecks.Under15(props.dateOfBirth)) {
