...
import VeteransPage             from '../../../../client/presentations/cdl/my-history/veterans-service-page.jsx';
...
describe('VeteransServicePage', function() {
  ...
  describe('when veteran is getting a new card', function() {
    it('selecting Yes renders benefits, military waiver and identifier forms', function() {
      props.veteransService.isVeteran = 'Yes';
      ...
      assert.ok(component.find('.veterans-military-waiver-form').length, 'veterans military waiver form did not render');
  ...
  describe('when veteran is renewing a card', function() {
    ...
    it('selecting Yes renders benefits, military waiver and designation forms', function() {
      props.veteransService.isVeteran = 'Yes';
