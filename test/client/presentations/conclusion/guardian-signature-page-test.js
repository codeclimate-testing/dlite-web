...
describe('GuardianSignaturePage', function() {
  ...
  describe('when it renders initially', function() {
    ...
    it('entering Yes to sign and filling in details makes next button no longer disabled', function() {
      ...
      props.guardianSignature.guardianInfo[0].street_1 = '865 Main Street',
      props.guardianSignature.guardianInfo[0].street_2 = 'Unit no. 05',
      props.guardianSignature.guardianInfo[0].city = 'Crazidino Here',
      props.guardianSignature.guardianInfo[0].state = 'CA',
      props.guardianSignature.guardianInfo[0].zip = '94000',
